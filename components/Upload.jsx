...
const process_address = "OBMUE39XclAoRzW45ucNz6SiDLewP1BxYWik4A-4DZg";
...
export function UploadDialog({ location }) {
    ...
    async function mint() {
        ...
        const response = await message({
            ...
            tags: [{ name: "Action", value: "Mint" }, { name: "Timestamp", value: timestamp.toString() }, { name: "Image_base64", value: "" }, { name: "Location", value: location }],
    ...
    async function mintAndToast(s) {
        ...
        toast({ title: "Image Added", description: `Image ID ${count}`, action: <a href={`https://www.ao.link/#/entity/${process_address}`} target="_blank" rel="noopener noreferrer"><ToastAction altText="Try again">View Transaction</ToastAction></a>})
    }
